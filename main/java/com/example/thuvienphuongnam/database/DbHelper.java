...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
           ...
           String dbLoaiSach = "CREATE TABLE LOAISACH(maloai integer primary key autoincrement, tenloai text,nhasx text)";
         ...
         sqLiteDatabase.execSQL("INSERT INTO THUTHU VALUES ('thuthu01', 'nguyen van A', 'abc123'),('thuthu02','tran van C', '123abc')");
